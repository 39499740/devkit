...
// 全站图标集：24x24 描边风格（lucide 风格），stroke=currentColor
...
const icons: Record<string, string> = {
  ...
  'wifi-off':
    '<line x1="2" x2="22" y1="2" y2="22"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 4.17-2.65"/><path d="M10.66 5c4.01-.36 8.14.9 11.34 3.76"/><path d="M16.85 11.25a10 10 0 0 1 2.22 1.68"/><path d="M5 12.86a10 10 0 0 1 5.17-2.69"/><path d="M19 5.64a15 15 0 0 1 3 2.44"/><path d="M12 20h.01"/>',
  clock: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  loader: '<path d="M21 12a9 9 0 1 1-6.219-8.56"/>',

  /* ---- 工具图标 ---- */
  braces:
    '<path d="M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5c0 1.1.9 2 2 2h1"/><path d="M16 21h1a2 2 0 0 0 2-2v-5c0-1.1.9-2 2-2v0a2 2 0 0 1-2-2V5a2 2 0 0 0-2-2h-1"/>',
  diff: '<path d="M12 3v18"/><rect x="14" y="5" width="7" height="7" rx="1"/><rect x="3" y="12" width="7" height="7" rx="1"/><path d="M17.5 5v3"/><path d="M16 6.5h3"/><path d="M6.5 16v3"/>',
  'file-diff':
    '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 9v6"/><path d="M7 12h6"/>',
  'file-code':
  ...
  binary:
    '<rect x="14" y="14" width="4" height="6" rx="2"/><rect x="6" y="4" width="4" height="6" rx="2"/><path d="M6 20h.01"/><path d="M14 10h.01"/><path d="M18 10h.01"/><path d="M6 14h.01"/>',
  ...
  regex: '<path d="M12 6v12"/><path d="M17.196 9 6.804 15"/><path d="m6.804 9 10.392 6"/>',
  ...
  sliders:
    '<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/><circle cx="9" cy="6" r="2"/><circle cx="15" cy="12" r="2"/><circle cx="7" cy="18" r="2"/>',
  ...
  component:
    '<path d="M5.5 8.5 9 12l-3.5 3.5L2 12l3.5-3.5Z"/><path d="M12 2l3.5 3.5L12 9 8.5 5.5 12 2Z"/><path d="M18.5 8.5 22 12l-3.5 3.5L15 12l3.5-3.5Z"/><path d="M12 15l3.5 3.5L12 22l-3.5-3.5L12 15Z"/>',
  ruler:
  ...
  'file-binary':
    '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 11h2v6"/>'
}

const html = computed(() => icons[props.name] ?? icons.help)
</script>
